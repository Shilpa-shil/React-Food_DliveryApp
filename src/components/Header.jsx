...
const logout =() =>{
  ...
  return (
  <header className="fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary onClick={() => setIsMenu(false)}">
...
{ isMenu && (
  ...
  {user && user.email === "shilpashilus39@gmail.com" && (
 <Link to={"/createItem"}>
...
<div className="flex items-center justify-between md:hidden w-full h-full">
  ...
  <div className='relative flex items-center justify-center'>
      ...
      <Link to={"/"} className="flex items-center gap-2">
    <img src={Logo} className="w-8 object-cover" alt="logo"/>
  <p className='text-headongColor text-xl font-bold'>
    City</p>
  </Link>
